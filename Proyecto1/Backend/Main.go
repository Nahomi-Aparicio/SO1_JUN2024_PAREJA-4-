...
// sirve para agrupar variables (llamadas campos) bajo un mismo tipo
...
func getMem() {
	for range time.Tick(time.Second * 2) {
		...
		//DATOS DE LA RAM PARA MANEJARLOS MAS FACILMENTE -------------------------
		...
		// PARA INSERTAR LA RAM EN LA BASE DE DATOS ISI :C----------------
		...
		//SOLO VERIFICO QUE CORRA LA CPU
